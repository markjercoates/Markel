...
public class IntegrationTestWebApiFactory : WebApplicationFactory<Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureServices(services =>
        {
            ...
            using (var scope = sp.CreateScope())
            {
                ...
                var logger = scopedServices.GetRequiredService<ILogger<IntegrationTestWebApiFactory>>();
